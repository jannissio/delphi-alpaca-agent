...
3. **Certified radius.** With the trailing 250 scores, `k_hat` is the smallest radius whose corrected empirical
   ...
   below `beta*` the online level has drifted above `beta*` (0.164 after 620 sessions), so the online layer is
...
## Result on the competition account (2026-09-03)

Zero trades, P&L $0, and that is the mechanism: the market offered 0.005 to 0.0725 of the wing for the certified band
